...
const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: '#F7F8FA' }, content: { flex: 1, padding: 24 }, title: { fontSize: guardianTypography.pageTitle, fontWeight: '800', color: '#191F28', marginBottom: 24 }, card: { padding: 20, borderRadius: 20, backgroundColor: '#FFFFFF', marginBottom: 12 }, warning: { backgroundColor: '#FFF7F7' }, tag: { fontSize: guardianTypography.caption, fontWeight: '800', color: '#F04452' }, cardTitle: { marginTop: 12, fontSize: guardianTypography.bodyStrong, fontWeight: '800', color: '#191F28' }, detail: { marginTop: 8, fontSize: guardianTypography.secondary, color: '#8B95A1' } });
