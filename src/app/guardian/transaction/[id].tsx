  ...
  const handleApproveConfirm =
    async () => {
      ...
      try {
        ...
        console.log(
          'GUARDIAN APPROVE TRANSACTION ID:',
          transactionId,
        );

        await guardianApproveTransfer(
          transactionId,
        );

        console.log(
          'GUARDIAN APPROVE SUCCESS',
        );
        ...
        console.log(
          'GUARDIAN APPROVE STATUS:',
          error?.response?.status,
        );

        console.log(
          'GUARDIAN APPROVE DATA:',
          error?.response?.data,
        );

        console.log(
          'GUARDIAN APPROVE MESSAGE:',
          error?.message,
        );

        console.log(
          'GUARDIAN APPROVE ERROR:',
          error,
        );
  ...
  const handleRejectConfirm =
    async () => {
      ...
      try {
        ...
        console.log(
          'GUARDIAN REJECT TRANSACTION ID:',
          transactionId,
        );

        await guardianRejectTransfer(
          transactionId,
        );

        console.log(
          'GUARDIAN REJECT SUCCESS',
        );
        ...
        console.log(
          'GUARDIAN REJECT STATUS:',
          error?.response?.status,
        );

        console.log(
          'GUARDIAN REJECT DATA:',
          error?.response?.data,
        );

        console.log(
          'GUARDIAN REJECT MESSAGE:',
          error?.message,
        );

        console.log(
          'GUARDIAN REJECT ERROR:',
          error,
        );
...
const styles =
  StyleSheet.create({
    ...
    sectionTitle: {
      fontSize:
        guardianTypography.sectionTitle,
      lineHeight: 30,
